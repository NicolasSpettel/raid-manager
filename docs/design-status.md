...
6. **Weekly activity mechanics** — the 4-slot day and the activity *list* exist; each activity
   (dungeon farm, training, professions, questing, rest, drills) needs its actual
