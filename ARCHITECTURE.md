...
world roster — attributes + condition intact — into the playable save) → roster. `dotnet build -warnaserror` + `dotnet test` green (147 tests).
